...
int main(int argc, char** argv) {
    ...
    if (std::strcmp(variant, "default") == 0) {
        conv_unroll(in, out, ker, H, W, K);
    } else if (std::strcmp(variant, "conv_unroll_v1") == 0) {
        conv_unroll_v1(in, out, ker, H, W, K);
    } else if (std::strcmp(variant, "conv_unroll_v2") == 0) {
        conv_unroll_v2(in, out, ker, H, W, K);
    } else if (std::strcmp(variant, "conv_unroll_v3") == 0) {
        conv_unroll_v3(in, out, ker, H, W, K);
    } else if (std::strcmp(variant, "conv_unroll_v4") == 0) {
        conv_unroll_v4(in, out, ker, H, W, K);
    } else if (std::strcmp(variant, "conv_unroll_v5") == 0) {
