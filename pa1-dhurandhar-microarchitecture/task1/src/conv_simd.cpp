...
//g++ -std=c++17 -O2 -fno-tree-vectorize -mavx2 -mfma -Iinclude -Wall -DSTANDALONE_TEST src/conv_simd.cpp -o bin/conv_prof_simd
...
int main(int argc, char** argv) {
    ...
    } else if (std::strcmp(variant, "conv_simd128_v1") == 0) {
        conv_simd128_v1(in, out, ker, H, W, K);
    } else if (std::strcmp(variant, "conv_simd128_v2") == 0) {
        conv_simd128_v2(in, out, ker, H, W, K);
    } else if (std::strcmp(variant, "conv_simd128_v3") == 0) {
        conv_simd128_v3(in, out, ker, H, W, K);
    } else if (std::strcmp(variant, "conv_simd128_v4") == 0) {
        conv_simd128_v4(in, out, ker, H, W, K);
    } else if (std::strcmp(variant, "conv_simd256_v1") == 0) {
        conv_simd256_v1(in, out, ker, H, W, K);
    } else if (std::strcmp(variant, "conv_simd256_v2") == 0) {
        conv_simd256_v2(in, out, ker, H, W, K);
    } else if (std::strcmp(variant, "conv_simd256_v3") == 0) {
        conv_simd256_v3(in, out, ker, H, W, K);
    } else {
