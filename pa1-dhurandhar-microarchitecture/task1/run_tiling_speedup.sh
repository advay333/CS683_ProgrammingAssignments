...
{
echo "\n Cleaning bin and compiling again"
make clean
make all
echo "\n Compilation done"
}
...
echo "\n Done with 16384"
sudo perf stat -e cpu_core/L1-dcache-loads/,cpu_core/L1-dcache-load-misses/,cpu_core/branch-instructions/,cpu_core/branch-misses/,cpu_core/cache-misses/,cpu_core/cpu-cycles/,cpu_core/instructions/,context-switches taskset -c 0 bin/conv tile 32768 32768 3 1234
echo "\n Done with 32768"
} > "$FULL_LOG_PATH" 2>&1
